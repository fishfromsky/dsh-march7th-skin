...
body[data-march7th-skin] [data-slot='sidebar']
  ...
  border-radius: 18px;
  background:
    url('/skins/march7th/new-session.webp')
    center / 100% 100% no-repeat;
  color: #a64279;
  font-weight: 600;
  box-shadow: none;
...
/* Slash command palette: the source marker is part of ui-input-trigger's
   public DOM contract, so this targets the command suggestions without
   changing other listboxes such as attachments or popup-select commands. */
body[data-march7th-skin] [data-composer-card]
  [role='listbox']:has([role='presentation'][data-source='command']) {
  --dsw-alias-label-primary: #6f3153;
  --dsw-alias-label-secondary: #87506f;
  --dsw-alias-label-tertiary: #9b7189;
  --dsw-alias-label-dimmed: #c39aaf;
  --dsh-scrollbar-thumb: rgba(221, 105, 164, 0.38);
  --dsh-scrollbar-thumb-hover: rgba(208, 78, 145, 0.58);
  padding: 10px;
  border: 1px solid rgba(224, 105, 165, 0.48);
  border-radius: 22px;
  background:
    radial-gradient(circle at 8% 0%, rgba(255, 255, 255, 0.98), transparent 38%),
    radial-gradient(circle at 94% 100%, rgba(220, 216, 255, 0.56), transparent 42%),
    linear-gradient(145deg, rgba(255, 252, 255, 0.975), rgba(255, 232, 246, 0.955) 58%, rgba(239, 233, 255, 0.96));
  color: #6f3153;
  box-shadow:
    inset 0 1px rgba(255, 255, 255, 0.98),
    0 22px 58px rgba(91, 49, 103, 0.28),
    0 0 0 4px rgba(255, 221, 240, 0.28);
  backdrop-filter: blur(24px) saturate(1.16);
}

body[data-march7th-skin] [data-composer-card]
  [role='listbox']:has([role='presentation'][data-source='command'])
  [role='presentation'][data-source='command'] {
...
body[data-march7th-skin] [data-composer-card]
  [role='listbox']:has([role='presentation'][data-source='command'])
  button[role='option'] > span:nth-last-child(2):not([aria-hidden]) {
  color: #743252;
  font-weight: 650;
}
...
body[data-march7th-skin] [data-composer-card]
  [role='listbox']:has([role='presentation'][data-source='command'])
  button[role='option'] > span:first-child:not([aria-hidden]) + span:last-child,
body[data-march7th-skin] [data-composer-card]
  [role='listbox']:has([role='presentation'][data-source='command'])
  button[role='option'] > span[aria-hidden] + span + span:last-child {
  color: #967089;
}

body[data-march7th-skin] [data-composer-card]
  [role='listbox']:has([role='presentation'][data-source='command'])
  button[role='option']:is(:hover, :focus-visible, [aria-selected='true']) {
  border-color: rgba(220, 92, 157, 0.34);
  background: linear-gradient(100deg, rgba(255, 211, 235, 0.82), rgba(227, 221, 255, 0.74));
  color: #8f315f;
  box-shadow:
    inset 3px 0 #df5798,
    inset 0 1px rgba(255, 255, 255, 0.9),
    0 6px 16px rgba(146, 65, 117, 0.12);
  outline: none;
}
...
body[data-march7th-skin] [data-composer-card]
  [role='listbox']:has([role='presentation'][data-source='command'])
  button[role='option']:is(:hover, :focus-visible, [aria-selected='true'])
  > span:nth-last-child(2):not([aria-hidden]) {
  color: #8f315f;
}
...
body[data-march7th-skin] [data-composer-card]
  [role='listbox']:has([role='presentation'][data-source='command'])
  button[role='option']:is(:hover, :focus-visible, [aria-selected='true'])
  > span:first-child:not([aria-hidden]) + span:last-child,
body[data-march7th-skin] [data-composer-card]
  [role='listbox']:has([role='presentation'][data-source='command'])
  button[role='option']:is(:hover, :focus-visible, [aria-selected='true'])
  > span[aria-hidden] + span + span:last-child {
  color: #875a75;
}
...
body[data-march7th-skin][data-ds-dark-theme] [data-composer-card]
  ...
  --dsh-scrollbar-thumb: rgba(115, 126, 170, 0.46);
  --dsh-scrollbar-thumb-hover: rgba(151, 162, 205, 0.62);
  border-color: rgba(188, 167, 255, 0.32);
  background:
    radial-gradient(circle at 10% 0%, rgba(141, 215, 255, 0.1), transparent 38%),
    radial-gradient(circle at 94% 100%, rgba(255, 111, 173, 0.1), transparent 42%),
    linear-gradient(145deg, rgba(16, 23, 42, 0.985), rgba(28, 31, 56, 0.975));
  color: var(--m7-night-ink);
  box-shadow:
    inset 0 1px rgba(255, 255, 255, 0.055),
    0 22px 58px rgba(2, 5, 15, 0.54),
    0 0 0 4px rgba(103, 91, 170, 0.12);
...
body[data-march7th-skin][data-ds-dark-theme] [data-composer-card]
  ...
  background: linear-gradient(100deg, rgba(255, 111, 173, 0.17), rgba(148, 125, 235, 0.15));
  color: #ffe2ef;
  box-shadow:
    inset 3px 0 var(--m7-night-pink-strong),
    inset 0 1px rgba(255, 255, 255, 0.045),
    0 6px 18px rgba(2, 5, 15, 0.22);
}
